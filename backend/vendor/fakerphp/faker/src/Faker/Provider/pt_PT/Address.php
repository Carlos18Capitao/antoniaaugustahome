...
class Address extends \Faker\Provider\Address
{
    ...
    /**
     * @see http://www.mapadeAngola.net/indicecidades.asp *
     */
    private static $cities = [
        ...
        'Leiria', 'Luanda', 'Lixa', 'Loulé', 'Loures', 'Lourosa', 'Macedo de Cavaleiros', 'Machico', 'Maia', 'Mangualde', 'Marco de Canaveses', 'Marinha Grande',
    ...
    protected static $country = [
        ...
        'Países Baixos', 'Peru', 'Polónia', 'Angola', 'Reino Unido',
